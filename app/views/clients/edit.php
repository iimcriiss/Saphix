...
<div class="flex items-center gap-3 mb-6">
    ...
    <h2 class="text-lg font-bold text-gray-700 dark:text-yt-text transition-colors duration-300">Editar cliente</h2>
</div>
        ...
        <div class="grid grid-cols-2 gap-5">
            ...
            <div class="col-span-2 sm:col-span-2">
                ...
                <textarea name="direccion" rows="2"
                    class="w-full border border-gray-300 dark:border-yt-border dark:bg-neutral-900 dark:text-yt-muted rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors duration-300""><?= $cliente['direccion'] ?></textarea>
            </div>
